...
Route::get('user/profile', [App\Http\Controllers\HomeController::class, 'profile'])->name('profile.user');
Route::post('user/update/profile', [App\Http\Controllers\HomeController::class, 'updateProfile'])->name('update.user');
